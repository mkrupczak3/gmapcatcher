...
def search_location(location):
    ...
    try:
        #oa = openanything.fetch('http://mt1.google.com/vt/lyrs=m&x=1325&y=3143&z=13
        oa = openanything.fetch( googleUrl)
    except Exception:
